...
void Hangman::startGame()
{
    ...
    sf::Clock gameClock; // Starts the timer
    const int gameDuration = 90; // 90 seconds
    sf::Text timerText;
    timerText.setFont(font); // Make sure your font is loaded
    timerText.setCharacterSize(50);
    timerText.setFillColor(sf::Color::Red);
    timerText.setPosition(50, 20); // Top-left corner of screen
    ...
    while (window.isOpen()) {
        ...
        // Update timer
        int secondsPassed = static_cast<int>(gameClock.getElapsedTime().asSeconds());
        int timeLeft = gameDuration - secondsPassed;

        // Convert timeLeft to string and show it
